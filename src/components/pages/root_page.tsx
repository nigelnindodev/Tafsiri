    ...
    return (
        <html data-theme="dark">
            <head>
                ...
                <link
                    rel="stylesheet"
                    href={`${config.baseUrl}/public/pico.min.css`}
                />
                <link
                    rel="stylesheet"
                    href={`${config.baseUrl}/public/custom.css`}
                />
            ...
            <body>
                ...
                <div
                    hx-get="/root"
                    hx-trigger={`load, ${ServerHxTriggerEvents.LOGIN_STATUS_CHANGE} from:body`}
                    hx-target={`#${HtmxTargets.ROOT_DIV}`}
                />
                <div
                    hx-get="/todo"
                    hx-trigger={`${ServerHxTriggerEvents.GENERAL_ERROR} from:body`}
                    hx-target={`#${HtmxTargets.ROOT_DIV}`}
                />
            </body>
        </html>
